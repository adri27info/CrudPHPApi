...
<body>
    ...
    <main>
        <form id="formulario" class="formulario insertar" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>"
            method="POST">
            ...
            <input type="text" name="direccion_usuario" id="direccion_usuario"
                placeholder="Introduce la direccion del usuario">
            <div class="contenedorDireccionUsuario ocultar" id="contenedorDireccionUsuario">
                <span class="material-symbols-outlined"> pin_drop </span>
                <span id="error_direccion" class="error_direccion">Error [-4, +20]. Debes introdir minimo 4 y maximo 20
                    caracteres</span>
            </div>
            <label for="telefono_usuario">Telefono: </label>
            <input type="text" name="telefono_usuario" id="telefono_usuario"
                placeholder="Introduce el telefono del usuario">
            <div class="contenedorTelefonoUsuario ocultar" id="contenedorTelefonoUsuario">
                <span class="material-symbols-outlined"> call </span>
                <span id="error_telefono" class="error_telefono">Error[-9, +9]. El telefono tiene que empezar entre los
                    numeros {6,7,9}</span>
            </div>
